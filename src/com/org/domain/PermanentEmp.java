...
private double basic,hra,pf,deduction;
...
public String toString() {
	return "PermanentEmp [paid_leave=" + paid_leave + ", sick_leave=" + sick_leave + ", casual_leave=" + casual_leave
			+ ", basic=" + basic + ", hra=" + hra + ", pf=" + pf + ", deduction=" + deduction + ", empid=" + getEmpid()
			+ ", empName=" + getEmpName() + ", total_leaves=" + getTotal_leaves() + 
			", total_salary=" + getTotal_salary() + "]";
}
